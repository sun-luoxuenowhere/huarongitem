    ...
    state: {
	   ...
	   //考核记录
	    ...
	    jinjiFormConfig: [{ id: 'linkman', text: '联系人' },
		    ...
		    { id: 'officephone', text: '办公电话',"valid": [{ validator: validForm.tel, required: true, trigger: 'change' }] },
		    { id: 'homephone', text: '家庭电话',"valid": [{ validator: validForm.tel, required: true, trigger: 'change' }] },
		    { id: 'mobile', text: '手机',"valid": [{ validator: validForm.phone, required: true, trigger: 'change' }]},
		    { id: 'fax', text: '传真' },
		    { id: 'email', text: '电子邮件',"valid": [{ validator: validForm.email, required: true, trigger: 'change' }] }],
	    //语言能力表单配置
	    yuyanFormConfig: [
