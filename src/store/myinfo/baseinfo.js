...
export default {
    state: {
    	...
    	baseInfo2: [{ "id": "nationality", "text": "民族", "type": "refer", "typedata": [{"code": "HR002_0xx"}], "valid": [{ required: true, message: '不能为空', trigger: 'change' }]},
			...
			{ "id": "nativeplace", "text": "籍贯", "valid": [{ required: true, message: '不能为空', trigger: 'change' }] },
			...
			{ "id": "country", "text": "国籍/地区", "valid": [{ required: true, message: '不能为空', trigger: 'change' }] },
			{ "id": "permanreside", "text": "户口所在地" },
